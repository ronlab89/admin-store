...
const headingStyles = {
  ...
  h2: "lg:text-[36px] xl:text-[40px] min-[1440px]:text-[49px] font-bold lg:leading-[50.15px] min-[1440px]:leading-[66.15px] tracking-[-2px]",
  h3: "lg:text-[24px] min-[1440px]:text-[29px] font-bold lg:leading-[34.15px] min-[1440px]:leading-[39.15px] tracking-[-2px]",
  "h3.subtitle":
